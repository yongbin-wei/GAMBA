...
% load data
data = load(fullfile(datapath, 'LR_all_singlegene_all_pheno.mat'));
...
% % % save(fullfile(datapath, 'LR_all_singlegene_all_pheno.mat'),...
% % %     '-struct', 'data');
...
disp(tbl);
% % % writetable(tbl, [datapath, '/tbl_single_gene_all_pheno.xlsx'], ...
% % %     'WriteRowNames', true);
...
% % % saveas(gcf, '../figures/venn_all_singlegene_all_pheno.svg');
end
